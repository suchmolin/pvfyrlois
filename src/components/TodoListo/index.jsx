    ...
    return (
        <section id="tematicas" className="w-full flex flex-col items-center">
            <h2 className="text-center text-lg text-azul">¡Todo listo para que tu hijo viva <br />
                las mejores aventuras <b>en inglés este verano!</b>
            </h2>
            <div className="w-full flex justify-center py-5">
                <div className="flex flex-wrap gap-4 justify-center">
                    <a href="#exploracion" className="w-[150px] rounded-md overflow-hidden hover:scale-[102%] duration-300 cursor-pointer">
                        <img src="/img/exploracion.webp" alt="exploracion imagen" />
                    </a>
                    <a href="#deporte" className="w-[150px] rounded-md overflow-hidden hover:scale-[102%] duration-300 cursor-pointer">
                        <img src="/img/deporte.webp" alt="deporte imagen" />
                    </a>
                    <a href="#tecnologia" className="w-[150px] rounded-md overflow-hidden hover:scale-[102%] duration-300 cursor-pointer">
                        <img src="/img/tecnologia.webp" alt="tecnologia imagen" />
                    </a>
                    <a href="#conoceciudad" className="w-[150px] rounded-md overflow-hidden hover:scale-[102%] duration-300 cursor-pointer">
            ...
            <div className="w-full pt-15 pb-10 flex items-center justify-center bg-[url('/img/papel.webp')] bg-center bg-cover -mt-5">
                <div className="flex justify-center hover:scale-[102%] duration-300">
                    <a href="#contacto" className="flex text-naranja text-nowrap text-lg min-[375px]:text-xl min-[430px]:text-2xl lg:text-3xl xl:text-4xl font-eastman-bold items-center justify-center gap-2 bg-azul py-2 px-2 rounded-md mb-5 w-fit">
