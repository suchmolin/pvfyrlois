    ...
    return (
        <>
            <section className="w-full flex flex-col items-center border-azul border-t-2 bg-amarillo relative overflow-hidden pb-10 lg:pb-20">
                ...
                <h2 className="text-lg min-[370px]:text-xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-5xl  3xl:text-6xl 4xl:text-7xl text-azul eastman-bold text-center text-nowrap mt-5 mb-10 w-[430px] sm:w-full min-[470px]:my-5 sm:my-10 leading-5 sm:leading-6 md:leading-7 lg:leading-11 3xl:leading-15 4xl:leading-18">
                ...
                <div className="relative pr-4 pl-15 py-3 2xl:py-6 w-10/12 sm:w-8/12 xl:w-7/12 2xl:w-[880px] -mr-3">
                    ...
                    <h2 className="text-azul eastman-bold text-sm min-[520px]:text-base md:text-lg lg:text-2xl z-10 relative leading-4 sm:leading-5 md:leading-6 lg:leading-7">Podrá disfrutar de cada temática y aprender de
            ...
            <div className="w-full pt-7 pb-10 3xl:pb-20 flex items-center justify-center bg-[url('/img/papel.webp')] bg-center bg-cover relative">
                <div className="flex justify-center hover:scale-[102%] duration-300">
                    <a href="#contacto" className="flex text-naranja text-nowrap text-lg min-[375px]:text-xl min-[430px]:text-2xl xl:text-3xl 3xl:text-4xl 4xl:text-5xl eastman-bold items-center justify-center gap-2 bg-azul py-2 px-2 rounded-md mb-5 w-fit">
