export default function Aniversary() {
    return (
        <div className="py-10 bg-[url('/img/rayasgrisesfondo.webp')] bg-center bg-cover flex flex-col md:flex-row items-center overflow-hidden md:gap-4 md:justify-center">
            <div className="w-[320px] min-[400px]:w-[360px] lg:w-[450px]  rounded-md overflow-hidden flex-col flex mb-5 md:mb-0">
                ...
                <div className="w-full  h-[70px] flex bg-azul relative text-white text-xs min-[400px]:text-sm text-center">
                    <div className="w-1/2 flex justify-center py-5">
            ...
            <div className="w-[320px] min-[400px]:w-[360px] lg:w-[450px]  rounded-md overflow-hidden flex-col flex">
                ...
                <div className="w-full  h-[70px] flex bg-azul relative text-white text-xs min-[400px]:text-xs lg:text-sm text-center">
                    <div className="w-1/2 flex justify-center py-5">
