    ...
    return (
        <section id="contacto" className="w-full flex flex-col items-center pt-5">
            <div className="relative px-5 py-3 2xl:py-6">
                ...
                <h2 className="text-azul eastman-bold text-3xl lg:text-4xl 2xl:text-6xl text-center z-10 relative">CONTÁCTANOS</h2>
            </div>
            <h2 className="text-xl lg:text-3xl 2xl:text-5xl text-azul text-center eastman-bold leading-5 lg:leading-8 2xl:leading-13  my-5">¡Sus vacaciones de verano <br />
