    ...
    return (
        <section className="w-full flex flex-col items-center pt-10 pb-5">
            <div className="relative px-5 2xl:px-15 py-3 3xl:py-6">
                ...
                <h2 className="text-white eastman-bold text-2xl min-[480px]:text-3xl 2xl:text-5xl 4xl:text-6xl text-center z-10 relative text-nowrap">¡ASÍ SE VIVE LA<br /><span className="text-[#001A70]">EXPERIENCIA FYR LOIS!</span></h2>
            </div>
            ...
            <div className="flex justify-center hover:scale-[102%] duration-300">
                <a href="#contacto" className="flex text-[#FFA400] text-nowrap text-base min-[3650px]:text-lg min-[400px]:text-xl min-[460px]:text-2xl xl:text-3xl 3xl:text-4xl 4xl:text-5xl eastman-bold items-center justify-center gap-2 bg-[#001A70] py-2 px-2 rounded-md mb-5 w-fit">
