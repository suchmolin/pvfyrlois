export default function Summer2025() {
    return (
        <>
            <section className="py-10 bg-azul flex flex-col items-center justify-center overflow-hidden">
                <div className="w-[290px] min-[360px]:w-[350px] relative">
                    <img src="/img/logo2.png" alt="logo summer 2025 fyr lois" className="w-full" />
                </div>
                <div className="flex gap-3 h-full">
                    <div className=" w-[4px] rounded-lg bg-white"></div>
                    <h2 className="text-white min-[370px]:text-lg min-[440px]:text-2xl font-eastman-bold text-nowrap">26 AÑOS BRINDANDO <br />
