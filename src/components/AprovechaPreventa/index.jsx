    ...
    return (
        <>
            <section id="preventa" className="w-full bg-naranja relative pt-20 xl:py-30 pb-10">
                ...
                <h2 className="text-azul text-2xl min-[400px]:text-3xl sm:text-5xl md:text-5xl xl:text-6xl 3xl:text-7xl 4xl:text-8xl eastman-bold text-center leading-3 sm:leading-6 3xl:leading-10 4xl:leading-15">¡Aprovecha nuestra <span className="text-white text-5xl min-[400px]:text-6xl sm:text-8xl md:text-8xl xl:text-9xl 3xl:text-[150px] 4xl:text-[200px] block">preventa!</span></h2>
                ...
                <div className="flex flex-col items-center justify-center hover:scale-[102%] duration-300 py-7">
                    ...
                    <button onClick={() => checkoutHandler()} className="flex text-white text-nowrap text-lg min-[375px]:text-xl min-[430px]:text-2xl sm:text-3xl md:text-4xl xl:text-5xl 4xl:text-6xl  eastman-bold items-center justify-center gap-2 bg-azul py-2 4xl:py-4 px-2 lg:px-7 rounded-md mb-5 w-fit z-10 cursor-pointer">
            ...
            <section className="w-full bg-azul text-white flex gap-1 items-center justify-center px-3 py-7 min-[385px]:py-10 xl:py-20 3xl:py-30 border-b-5 border-black relative">
                ...
                <p className="text-sm min-[385px]:text-base min-[420px]:text-lg md:text-3xl lg:text-4xl xl:text-5xl 3xl:text-6xl 4xl:text-7xl eastman-bold leading-5 md:leading-7 lg:leading-8 xl:leading-11 3xl:leading-15 4xl:leading-17">¡Este summer es para vivir <span className="block text-verde ">grandes aventuras!</span></p>
