export default function Diferenciadores() {
    const square = "w-[40px] sm:w-[60px] lg:w-[80px] 2xl:w-[100px]  "
    return (
        <div className="w-full flex justify-center text-[#001A70] eastman-bold text-md
             min-[400px]:text-xl min-[460px]:text-2xl sm:text-3xl lg:text-4xl 2xl:text-5xl mt-5">
            <div className="flex flex-col gap-2">
                <div className="flex gap-2 items-center">
                    <div className=" bg-[#97D700] p-2 rounded-lg">
                        <img src="/img/PERSONAESTRELLA.webp" alt="persona estrella icono" className={square} />
                    </div>
                    <div className="relative px-2 py-2 flex justify-center items-cente   ">
                ...
                <div className="flex gap-2 items-center">
                    <div className=" bg-[#001A70] p-2 rounded-lg">
                    ...
                    <div className=" bg-[#FFA400] p-2 rounded-lg">
