    ...
    return (
        <section id="edades" className="w-full flex flex-col items-center  overflow-hidden">
            ...
            <div className="flex justify-center hover:scale-[102%] duration-300 py-7 md:py-0">
                <a href="#" className="flex text-naranja text-nowrap text-lg min-[375px]:text-xl min-[430px]:text-2xl md:text-3xl xl:text-4xl font-eastman-bold items-center justify-center gap-2 bg-azul py-2 px-2 rounded-md mb-5 w-fit">
