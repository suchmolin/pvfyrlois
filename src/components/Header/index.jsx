        ...
        <section id="inicio" className="w-full bg-[url('/img/cieloFondo.png')] bg-cover bg-center bg-no-repeat pt-10 flex flex-col md:flex-row items-center md:items-end relative justify-start md:justify-center">
            <div className="flex flex-col w-fit items-center pb-0 md:pb-20 xl:pb-30">
                ...
                <div className="relative px-5 py-4">
                    ...
                    <h2 className="text-azul font-bold text-3xl xl:text-4xl text-center z-10 relative leading-8">Plan vacacional <br /> totalmente <span className="text-white font-eastman-bold">en inglés</span></h2>
                </div>
                <h2 className="text-azul text-2xl xl:text-3xl italic font-eastman-bold mt-5">Primera etapa:</h2>
                <Contador />
