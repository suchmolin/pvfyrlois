    ...
    return (
        <section id="inicio" className="w-full bg-[url('/img/cieloFondo.png')] bg-cover bg-center bg-no-repeat pt-10 flex flex-col md:flex-row items-center md:items-end relative justify-start md:justify-center">
            <div className="flex flex-col w-fit items-center pb-0 md:pb-20">
                <img src="/img/logo2.png" alt="logo summjer Fyr Lois" className="w-[400px] xl:w-[500px] h-auto" />
            ...
            <img src="/img/ninoHeader.png" alt="Niño feliz yendo al plan vacacional de Fyr lois para aprender con clases 100% en ingles" className="w-[300px] md:w-[450px] lg:w-[550px] 2xl:w-[600px] h-auto relative" />
            <img src="/img/formaAmarilla.webp" alt="forma amarilla divisor de seccion" className="w-full absolute bottom-0 block sm:hidden" />
        </section>
    )
