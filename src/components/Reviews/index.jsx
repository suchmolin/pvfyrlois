    ...
    return (
        <section className="w-full bg-verde py-10 sm:py-20 flex flex-col items-center">
            <div className="relative pl-10 pr-5 py-3 sm:py-4 lg:py-6 2xl:py-8 -mr-30 3xl:-mr-35 2xl:mb-10">
                ...
                <h2 className="text-azul eastman-bold text-lg min-[360px]:text-xl min-[420px]:text-2xl sm:text-3xl lg:text-4xl xl:text-5xl  2xl:text-6xl 3xl:text-7xl z-10 relative leading-5 min-[420px]:leading-7 xl:leading-12 3xl:leading-15 pl-5 2xl:pl-10">Resultados que hablan <br /> por si solos</h2>
